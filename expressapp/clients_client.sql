CREATE DATABASE  IF NOT EXISTS `clients` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `clients`;
...
CREATE TABLE `client` (
  ...
  CONSTRAINT `Handler` FOREIGN KEY (`Handler`) REFERENCES `organisation` (`OrganisationID`)
...
-- Dump completed on 2021-08-04 12:08:40
